...
# Importación del dataframe desde GitHub
df = pd.read_csv('https://raw.githubusercontent.com/alaya-digital-solutions/ch-2021-primer-semestre/master/fault-classification/data/data.csv')
df.sample()
...
# Inspección de los datos y detección de datos nulos
df.info()
...
# Inspección de los datos de calibración
